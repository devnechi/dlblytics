...
<div class="container-fluid">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="title text-center">CREATE A TRAVEL ADVANCE REQUEST</h4>
            </div>
        </div>
        <form method="post" action="">
            ...
            <div class="row">
                <div class="form-group col-md-4 input-group-lg">
                    <label for="forKpi_dc_timing">Staff advance No: </label>
                    <input type="text" class="form-control" name="dc_timing"
                        value="<?= isset($_POST['dc_timing']) ? $_POST['dc_timing'] : ''; ?>" placeholder="">
                </div>
                <div class="form-group col-md-4 input-group-lg">
                    <label for="forKpi_classification">Date: </label>
                    <input type="date" class="form-control" name="classification"
                        value="<?= isset($_POST['classification']) ? $_POST['classification'] : ''; ?>" placeholder=""
                        required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-lg-12 input-group-lg">
                    <div class="form-group green-border-focus">
                        <label for="forPillarBriefDescription">Purpose of Travel Summary:
                        </label>
            ...
            <div class="row">
                <div class="form-group col-md-6 input-group-lg">
                    <label for="forKpi_title">To be Reviewed by: </label>
                    <input type="text" class="form-control" name="kpi_title"
                    value="<?= isset($_POST['kpi_title']) ? $_POST['kpi_title'] : ''; ?>"
                    placeholder="" required>
                </div>
            ...
            <div class="row">
                <div class="form-group col-md-6 input-group-lg">
                    <label for="forKpi_title">To be Approved by: </label>
                    <input type="text" class="form-control" name="kpi_title"
                    value="<?= isset($_POST['kpi_title']) ? $_POST['kpi_title'] : ''; ?>"
                    placeholder="" required>
                </div>
