                            ...
                            <div class="card">
                                <div class="card-content table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            @php $i=1;@endphp
                                            @foreach($mysubactivities as $myact)
                                            <tr>
                                                <th scope="row">{{ $i}}</th>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-content table-responsive">
                                    ...
                                    $cosubactivities=$mysubactivities->where('status','completed');
                                    @endphp
                                    @if(count($cosubactivities)==0)
                                    <div class="d-flex p-2 justify-content-center">No Record Found!</div>
                                    @else
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            @php $co=1;@endphp @foreach($cosubactivities as $myact)
                                            <tr>
                                                <th scope="row">{{ $co}}</th>
                                                <td class="w-30 p-2">{{ $myact->subact_title }}</td>
                                                <td class="w-30 p-2">{{ $myact->total_subactivity_cost }}</td>
                                                ...
                                                <td class="w-10 p-2">{{ $myact->created_at }}</td>
                                                <td class="w-30 p-2">
                                                    <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#subatco{{$myact->id}}"> Actions
                                                    </button>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="subatco{{$myact->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLongTitle">Select Type of Request</h5>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-content table-responsive">
                                    ...
                                    $insubactivities=$mysubactivities->where('status','!=','completed');
                                    @endphp
                                    @if(count($insubactivities)==0)
                                    <div class="d-flex p-2 justify-content-center">No Record Found!</div>
                                    @else
                                    <table class="table table-bordered table-hover">
                                        <p class="d-flex justify-content-between"><strong>All SubActivities </strong>
                                        ...
                                        <tbody>
                                            @php $in=0;@endphp
                                            @foreach($insubactivities as $myact)
                                            <tr>
                                                <th scope="row">{{ $in}}</th>
                                                <td class="w-30 p-2">{{ $myact->subact_title }}</td>
                                                <td class="w-30 p-2">{{ $myact->total_subactivity_cost }}</td>
                                                ...
                                                <td class="w-10 p-2">{{ $myact->created_at }}</td>
                                                <td class="w-30 p-2">
                                                    <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#subactin{{$myact->id}}"> Actions
                                                    </button>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="subactin{{$myact->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLongTitle">Select Type of Request</h5>
