...
<div class="container pl-2 mt-5">
    ...
    <div class=" mt-3 mb-3  border p-3 ">
        ...
        <h4 class="m-1"> <strong>Sub activities </strong></h4>
        <div class="d-flex justify-content-between">
            <p>
                <span>{{count($activt->subactivities)}} Sub activities </span>
            </P>
            <a href="\\"><strong>Total Amount: </strong>{{$activt->total_act_cost}}</a>
        </div>
    </div>
