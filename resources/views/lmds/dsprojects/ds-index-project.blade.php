                                ...
                                <div class="tab-pane fade show active" id="vds-ds-project-ed-pills-reviewed-content" role="tabpanel" aria-labelledby="vds-ed-reqs-pills-home-tab">
                                    <div class="row">
                                        ...
                                        <p class="d-flex justify-content-end">
                                                            <a class="btn btn-outline-info  mr-1" href="{{ route('ds-create-new-project') }}" role="button"> create a new project</a>
                                                        </p>
                                            <div class="card">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-content table-responsive">
                                                    <br />
                                                    @php
                                                    $coprojects=$myprojects->where('status','completed');
                                                    @endphp
                                                    @if(count($coprojects)==0)
                                                    <div class="d-flex p-2 justify-content-center">No Record Found!</div>
                                                    @else
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $co=1;
                                                            @endphp
                                                            @foreach($coprojects as $myproject)
                                                            <tr>
                                                                <th scope="row">{{$co}}</th>
                                                                <td class="w-30 p-2">{{ $myproject->project_title }}</td>
                                                                <td class="w-30 p-2">{{ $myproject->total_project_cost }}</td>
                                                                ...
                                                                <td>{{$myproject->created_at->format('Y-m-d')}}
                                                                <td class="w-30 p-2">
                                                                    <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#prco{{$myproject->project_id }}"> Actions
                                                                    </button>
                                                                    <!-- Modal -->
                                                                    <div class="modal fade" id="prco{{$myproject->project_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-proj="{{ $myproject->project_id }}" data-user="{{ Auth::user()->user_id }}">
                                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title" id="exampleModalLongTitle">Select Type of Request</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="card-content table-responsive">
                                                    <br />
                                                    @php
                                                    $inprojects=$myprojects->where('status','!=','completed');
                                                    @endphp
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $in=1;
                                                            @endphp
                                                            @foreach($inprojects as $myproject)
                                                            <tr>
                                                                <th scope="row">{{$in}}</th>
                                                                <td class="w-30 p-2">{{ $myproject->project_title }}</td>
                                                                <td class="w-30 p-2">{{ $myproject->total_project_cost }}</td>
                                                                ...
                                                                <td>{{$myproject->created_at->format('Y-m-d')}}
                                                                <td class="w-30 p-2">
                                                                    <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#prin{{$myproject->project_id }}"> Actions
                                                                    </button>
                                                                    <!-- Modal -->
                                                                    <div class="modal fade" id="prin{{$myproject->project_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-proj="{{ $myproject->project_id }}" data-user="{{ Auth::user()->user_id }}">
                                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title" id="exampleModalLongTitle">Select Type of Request</h5>
