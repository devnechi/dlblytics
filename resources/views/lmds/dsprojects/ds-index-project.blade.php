        ...
        <div class="col-lg-12">
            <nav>
                <div class="nav nav-tabs" id="ds-pna-activities-nav-tab" role="tablist">
                    <a class="nav-link nav-item active" id="vds-ds-project-ed-pills-reviewed-tab" data-toggle="tab"
                        href="#vds-ds-project-ed-pills-reviewed-content" role="tab"
                        aria-controls="vds-ed-reqs-pills-reviewed" aria-selected="true">All Projects</a>

                    <a class=" nav-item nav-link" id="vds-ds-project-ed-pills-approved-tab" data-toggle="tab"
                        href="#vds-ds-act-ed-pills-approved-content" role="tab"
                        aria-controls="vds-ed-reqs-pills-approved" aria-selected="false">Completed</a>

                    <a class=" nav-item nav-link" id="vds-ds-project-ed-pills-all-tab" data-toggle="tab"
                        href="#vds-ds-act-ed-pills-denied-content" role="tab" aria-controls="vds-ed-reqs-pills-all"
                                                ...
                                                <div class="card-content table-responsive">
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        <p class="d-flex justify-content-between">
                                                            ...
                                                            <a class="btn btn-outline-info btn-lg mr-1"
                                                                href="{{ route('ds-create-new-project') }}"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="w-30 p-2">{{ $myproject->project_title }}
                                                                </td>
                                                                <td class="w-30 p-2">
                                                                    {{ $myproject->total_project_cost }}</td>
                                                                <td class="w-30 p-2">{{ $myproject->current_stage }}
                                                                </td>
                                                                <td class="w-30 p-2">{{ $myproject->review_status }}
                                                                </td>
                                                                ...
                                                                <td class="w-30 p-2">
                                                                    <button type="button"
                                                                        ...
                                                                        data-toggle="modal"
                                                                        data-target="#pr{{$myproject->project_id }}">
                                                                        Actions
                                                                    </button>
                                                                    <!-- Modal -->
                                                                    <div class="modal fade"
                                                                        id="pr{{$myproject->project_id }}" tabindex="-1"
                                                                        role="dialog"
                                                                        aria-labelledby="exampleModalCenterTitle"
                                                                        aria-hidden="true"
                                                                        data-proj="{{ $myproject->project_id }}"
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <ul class="list-group-flush">
                                                                                        <li class="list-group-item">
                                                                                            <a href="{{ route('ds-create-new-activity', $myproject->project_id) }}"
                                                                                                class="btn  btn-outline-secondary d-flex justify-content-between">
                                                                                                <i
                                                                                                    class="fas fa-chalkboard fa-lg mt-auto mb-auto"></i>
                                                                                                <p class="m-auto"> New
                                                                                                    Activity</p>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="list-group-item">
                                                                                            <a href="{{ route('pillar-project.show',   $myproject->project_id)}}"
                                                                                                class="btn btn-outline-success d-flex justify-content-between"
                                                                                                data-bs-toggle="tooltip"
                                                                                                data-bs-placement="top"
                                                                                                title="view project full details">
                                                                                        ...
                                                                                        <li class="list-group-item">
                                                                                            <a href="{{ route('edit-project', $myproject->project_id)}}"
                                                                                                class="btn btn-outline-info btn-md d-flex justify-content-between"
                                                                                                data-bs-toggle="tooltip"
                                                                                                data-bs-placement="top"
                                                                                                title="view update project details">
                                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                    width="32"
                                                                                                    height="32"
                                                                                                    fill="currentColor"
