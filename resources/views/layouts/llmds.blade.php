                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        ...
                        <div class="collapse" id="nav-new-reports">
                            <a id="data-science-imprest-tab-md" href="{{route('imprest.index')}}">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-caret-right-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12.14 8.753l-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z" />
                                </svg>
                                Imprests</a>
                                <a id="data-science-request-tab-md" href="{{route('reqindex')}}">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-caret-right-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12.14 8.753l-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z" />
                                </svg>
                            Request</a>
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                data: [{
                    ...
                    dataPoints: [{
                        ...
                        {
                            y: 6,
                            label: "Sector: Governance / decision making"
                        }
                    ]
                }]
            });
            ...
            var chart = new CanvasJS.Chart("chartCapacityBuildingActivities", {
                ...
                data: [{
                    ...
                    dataPoints: [{
                        ...
                        {
                            y: 34.45,
                            label: "Access to Information Resources",
                            color: "orange"
                        },
                        {
                            y: 22.31,
                            label: "Technical Infrastructure/equipment",
                            color: "blue"
                        },
                        {
                            y: 17.45,
                            label: "Policies/Standard Guidelines/Systems",
                            color: "green"
                        },
                        {
                            y: 6.31,
                            label: "Leadership/Strategic Thinking/Governance",
                            color: "pink"
                        },
                    ]
                }]
