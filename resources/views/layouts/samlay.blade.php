        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                <div class="sidebar-header">
                    <h3> DLAB admin Dashboard</h3>
                </div>

                <ul class="list-unstyled components">
                    <p style="font-size:800;">Navigation</p>
                    <li><a href="dlab_dashboard.php">Dashboard</a></li>
                    <!-- <li><a href="dlab_create_project.php">Create A new project</a></li> -->
                    <li><a href="dlab_update_data.php">Update Data</a></li>
                    <!-- <li><a href="dlab_data_tests.php"> Data Mapping</a></li> -->
                    <li><a href="dlab_manage_users.php">Manage Users</a></li>
                    <li>
                        <a href="{{ route('logout') }}"
...
<script src="https://canvasjs.com/assets/script/canvasjs.min.js"> </script>
    ...
    $(document).ready(function(){
        $('#selectProject').on('change', function() {
          if ( this.value == 'dli')
          {
            $("#pnl_select_activity").show();
             // document.getElementById("selected_batch_id").innerHTML = $(this).find("option:selected").text();
             $("#pnl_select_project").hide();



          }else if (this.value == 'datazetu') {
            $("#pnl_select_activity").show();
            $("#pnl_select_project").hide();

          }else if (this.value == 'dcli') {
            $("#pnl_select_activity").show();
            $("#pnl_select_project").hide();
