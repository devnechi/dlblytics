...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs md-tabs" id="selectDataViewTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="generalised-tab-md" data-toggle="tab" href="#generalised-md" role="tab"
                aria-controls="generalised-md" aria-selected="false">Generalised Data</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="specific-tab-md" data-toggle="tab" href="#specific-md" role="tab"
                aria-controls="specific-md" aria-selected="false">Specific Data</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="stats-tab-md" data-toggle="tab" href="#stats-md" role="tab" aria-controls="stats-md"
                aria-selected="false">Trends and Statistics</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="publicnprivatedata-tab-md" data-toggle="tab" href="#publicnprivatedata-md"
                role="tab" aria-controls="publicnprivatedata-md" aria-selected="false">Private and Public
                Data</a>
        </li>
    </ul>
    ...
    <div class="tab-content pt-5" id="selectDataViewTabContent">
                    ...
                    <div class="card">
                        <div class="card-content table-responsive">
                            <div class="row">
                                <div class="col-lg-12">
                                    <br />
                                    <h5 class="title text-center">Dlab pillars</h5>
                                    <br />
                                    <div class="row">
                                        <div class="form-group col-md-3 input-group-lg">

                                            <svg class="bi bi-award-fill" width="6em" height="6em" viewBox="0 0 16 16"
                                        ...
                                        <div class="form-group col-md-9 input-group-lg">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">
                                                    <svg class="bi bi-folder-fill" width="1em" height="1em"
                                                        viewBox="0 0 16 16" fill="#0488ae"
                                        ...
                                        <div class="form-group col-lg-12 input-group-lg">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item"><strong>Total People
                                                        Reached</strong> - over <strong>+
                                                        8000 </strong> direct and indirect
                                                    beneficiaries impacted</li>
                                                <!-- <li class="list-group-item"><strong>5000+ </strong> -Women impacted by <strong>dlab</strong> projects</li>
        ...
        <!-- end of overview data panel -->

        <!-- =========================================
               =                                       =
               =             start of generalised data =
               ========================================= -->

        <div class="tab-pane fade" id="generalised-md" role="tabpanel" aria-labelledby="generalised-tab-md">
            <!-- line chart -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">Dlab CAPACITY BUILDING ACTIVITIES</h4>
                            <p class="category text-center">Percentage of activity participants who are
                                Youths, 2019</p>
                        </div>
                        <div class="card-content table-responsive">

                                    <div id="chartLinesCapacityBuildingActivities" style="height: 370px; width: auto;">
                                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">USE STORIES</h4>
                            <p class="category text-center">Number of packaged data "Use Stories", 2019
                            </p>
                        </div>
                        <div class="card-content table-responsive">
                            <!-- <label for="exampleFormControlSelect1" class="control-label">select below:</label> -->
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">Demographic</h4>
                            <p class="category text-center">Percentage of activity participants who
                                reported positive change as a result of Dlab Intervention, 2019</p>
                        </div>
                        <div class="card-content table-responsive">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">Youth Participation</h4>
                            <p class="category text-center">Percentage of activity participants who are
                                Youths, 2019</p>
                        </div>
                        <div class="card-content table-responsive">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div id="chartComparisonLines" style="height: 370px; width: 100%;"></div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">Capacity Building activities</h4>
                            <p class="category text-center">Number of Dlab data related Capacity Building
                                Activities, 2019</p>
                        </div>
                        <div class="card-content table-responsive">

                            <div id="chartCapacityBuildingActivities" style="height: 370px; width: 100%;">
                            </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">Stakeholder Access</h4>
                            <p class="category text-center">Number of Stakeholders accessing Dlab Data
                                Tools, 2019</p>
                        </div>
                        <div class="card-content table-responsive">
                        ...
                        <div class="card-content table-responsive">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div id="chartLineYouthParticipation" style="height: 370px; width: 100%;"></div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">Dlab Interventions</h4>
                            <p class="category text-center">Percentage of activity participants who
                                reported positive change as a result of Dlab Intervention</p>
                        </div>
                        <div class="card-content table-responsive">

                            <div id="chartDcliIntervention" style="height: 370px; width: 100%;"></div>
                        </div>
                    </div>
                    <!-- end of first column -->
                </div>
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">Facilitated Dlab events</h4>
                            <p class="category text-center">Number of Data related Events facilitated by
                                Dlab, 2019</p>
                        </div>
                        <div class="card-content table-responsive">

                            <div id="chartDcliRelatedEvents" style="height: 370px; width: 100%;"></div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">Training</h4>
                            <p class="category text-center">Number of Dlab Training Package provided to
                                Target Stakeholders, 2019</p>
                        </div>
                        <div class="card-content table-responsive">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group col-lg-offset-3 col-md-6 input-group-lg">
                                        <!-- <label for="exampleFormControlSelect1" class="control-label">select below:</label> -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">Female Participation</h4>
                            <p class="category text-center">Percentage of activity participants who are
                                Female, 2019</p>
                        </div>
                        <div class="card-content table-responsive">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title text-center">GENERATED DATA POINTS </h4>
                            <p class="category text-center">Number of New Data points generated as a
                                result of Dlab intervention, 2019</p>
                        </div>
                        <div class="card-content table-responsive">
                            <div class="row">
                                <div class="col-lg-12">
        ...
        <!-- end of generalised data column -->
        <!--
               =========================================
               =                                       =
               =      start of specific data           =
               ========================================= -->
        <!-- start of specific data panel -->
        <div class="tab-pane fade" id="specific-md" role="tabpanel" aria-labelledby="specific-tab-md">
        ...
        <!-- end of specific data panel -->
        <!--
         ========================================
         =                                      =
         =       start of statistics and trends =
         ======================================== -->
        <!-- start of statistics data panel -->
        <div class="tab-pane fade" id="stats-md" role="tabpanel" aria-labelledby="stats-tab-md">
        ...
        <!--
         ========================================
         =                                      =
         =       start of private and public =
         ======================================== -->
        <!-- start of private and public data panel -->
        <div class="tab-pane fade" id="publicnprivatedata-md" role="tabpanel"
            aria-labelledby="publicnprivatedata-tab-md">
            <p>Data that is public and data that is still private a concept to be discussed</p>
            <br />
            <br />
        </div>
        <!-- end of private and public data panel -->
    </div>
