            ...
            <div class="card">
                  ...
                  <div class="card-content table-responsive">
                    <div class="row">
                      ...
                      <a class="btn btn-outline-primary btn-lg" href="{{ route('create-user') }}" role="button">create new user</a>
              ...
              <div class="row">
                <div class="col-md-9 offset-md-3">
                  <form class="form-inline">
                        <div class="col-md-4">
                          <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Enter user email..." aria-label="User search" aria-describedby="basic-addon2">
                  ...
                  <div class="col-lg-12">
                    ...
                    <td>active</td>
                    <td>12-03-2020</td>
                    <td><button type="button" class="btn btn-outline-info">Edit user</button>
