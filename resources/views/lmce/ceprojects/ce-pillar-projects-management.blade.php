...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-outline-info btn-lg" href="{{ route('ce-insert-new-project') }}"
                                                            ...
                                                            <table class="table table-bordered table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <td class="w-30 p-2"><a href="{{ route('ce-pillar-project.edit', $myproject->project_id)}}"
                                                        ...
                                                        <table class="table table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td class="w-30 p-2"><a href="{{ route('ce-pillar-project.edit', $myapprovedproject->project_id)}}"
                                                        ...
                                                        <table class="table table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td class="w-30 p-2"><a href="{{ route('ce-pillar-project.edit', $mydeniedproject->project_id)}}"
                                                                    class="btn btn-outline-info btn-md">update</a>
                                                                   </td>
                                                                </tr>
                                                        ...
                                                        <table class="table table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <td class="w-30 p-2"><a href="{{ route('ce-pillar-project.edit', $pillarproject->project_id)}}"
                                                                    class="btn btn-outline-info btn-md">update</a>
                                                                   </td>
                                                                </tr>
