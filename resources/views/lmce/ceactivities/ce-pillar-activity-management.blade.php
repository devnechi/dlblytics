...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
               ...
               <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#modalNewSoloActivity">
                create a new activity
            </button>

            <!-- Modal -->
            <div class="modal fade" id="modalNewSoloActivity" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Select Type of Activity</h5>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-content table-responsive">
                                                        ...
                                                        <table class="table table-bordered table-hover">
                                                            <p><strong>My Approved activities</strong></p>
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col">#</th>
                                                                    <th scope="col">activities title</th>
                                                                    <th scope="col-md-4">Total Estimated cost</th>
                                                                    <th scope="col">current stage</th>
                                                                    <th scope="col">status</th>
                                                                    <th scope="col">Date created</th>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-content table-responsive">
                                                        ...
                                                        <table class="table table-bordered table-hover">
                                                            <p><strong>My Denied Activities</strong></p>
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col">#</th>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-content table-responsive">
                                                        <br />
                                                        <table class="table table-bordered table-hover">
                                                            <p><strong>All Activities under this pillar</strong></p>
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col">#</th>
                                                                    <th scope="col">project title</th>
